...
PROJECT_ROOT="/private/tmp/line-backup-legacy-false-positive/56"
CONFIG="$PROJECT_ROOT/config/line_backup_config.json"
STATE="$PROJECT_ROOT/state/backup_state.json"
DEST="/private/tmp/line-backup-legacy-false-positive/56/destination"
EXPECTED=57
SAMPLES=3
INTERVAL=5
OUT_DIR="/private/tmp/line-backup-legacy-false-positive/56/output"

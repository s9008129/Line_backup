...
PROJECT_ROOT="/Users/hsiaojohnny/Documents/Codex/2026-09-07/line-album-backup-line-backup-state"
CONFIG="$PROJECT_ROOT/config/line_backup_config.json"
STATE="$PROJECT_ROOT/state/backup_state.json"
DEST="/Users/hsiaojohnny/Downloads/LINE-Backup-PoC/album-2024-05-13_to_2024-05-17_57"
EXPECTED=57
SAMPLES=3
INTERVAL=5
OUT_DIR="${0:A:h}"
